"""
Django settings for maeasam_project project.
"""
...
APP_NAME = 'maeasam_project'
APP_ROOT = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
STATICFILES_DIRS =  (os.path.join(APP_ROOT, 'media'),) + STATICFILES_DIRS

DATATYPE_LOCATIONS.append('maeasam_project.datatypes')
FUNCTION_LOCATIONS.append('maeasam_project.functions')
SEARCH_COMPONENT_LOCATIONS.append('maeasam_project.search_components')
...
ROOT_URLCONF = 'maeasam_project.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'maeasam_project'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'maeasam_project.search_indexes.sample_index.SampleIndex',
...
ALLOWED_HOSTS = ["database.maeasam.org"]

SYSTEM_SETTINGS_LOCAL_PATH = os.path.join(APP_ROOT, 'system_settings', 'System_Settings.json')
WSGI_APPLICATION = 'maeasam_project.wsgi.application'
...
SESSION_COOKIE_NAME = 'maeasam_project'
